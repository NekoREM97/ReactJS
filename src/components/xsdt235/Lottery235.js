...
class Lottery235 extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      system: 1,
      aNumber: numberInit,
      aAmountText: stringToNumberFormat(amountFix),
      aAmount: amountFix,
      aIsCheck: false,
      bNumber: numberInit,
      bAmountText: stringToNumberFormat(amountFix),
      bAmount: amountFix,
      bIsCheck: false,
      cNumber: numberInit,
      cAmountText: stringToNumberFormat(amountFix),
      cAmount: amountFix,
      cIsCheck: false,
      dNumber: numberInit,
      dAmountText: stringToNumberFormat(amountFix),
      dAmount: amountFix,
      dIsCheck: false,
      eNumber: numberInit,
  ...
  showAmount = param => {
    const BUTTONS = ["20,000", "50,000", "100,000", "Đóng"];
