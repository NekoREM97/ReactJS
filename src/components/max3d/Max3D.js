      ...
      <div className={styles2.content}>
        ...
        <div className={styles2.div_button} style={{ marginLeft: 6, marginRight: 6 }}>
          <div style={{ display: 'flex', padding: '4px 0' }}>
            <div>
              <img className={styles2.div_img} src={require("../../assets/max3d.png")} alt="" />
            ...
            <div className={styles2.div_group_text}>
              <div className={styles2.div_text_amt}><span className={styles2.span_text}>x</span>100<span className={styles2.span_text}>lần</span></div>
            </div>
          </div>
        </div>
