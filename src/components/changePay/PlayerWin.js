  ...
  render() {
    return (
      <div className={styles.content}>
        ...
        {/* <Button style={{marginLeft: "15px", marginRight:"15px", height:"40px", lineHeight: "40px", backgroundImage:"linear-gradient(to right, #00BDA0, #007DDD)", borderRadius:"4px", color:"white"}} onClick={() => this.onRules()}>Quy định đổi thưởng</Button> */}
        {/* <div
