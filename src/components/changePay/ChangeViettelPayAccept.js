...
class ChangeViettelPayAccept extends React.Component {
    ...
    onOk = () => {
        ...
        data.Signature = CryptoJS.SHA256(API_KEY + data.SourceChannel + data.MerchantID + data.TransAmount + data.MobileNumber + data.TransType + data.ChangeType + localStorage.getItem("token")).toString();
