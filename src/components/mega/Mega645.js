...
import { stringToNumberFormat, bag, getBagName, initBag, getPriceByBag, getWeekdaysShort } from '../../utils/Helper';
        ...
        return (<div className={styles2.content}>
            ...
            <div className={styles2.div_button} style={{ marginLeft: 6, marginRight: 6 }}>
                <div style={{ display: 'flex', padding: '4px 0' }}>
                    <div>
                        <img className={styles2.div_img} src={require("../../assets/mega.png")} alt="" />
                        <div className={styles2.div_img_text}><CountDownMega /></div>
                    </div>
                    <div className={styles2.div_border}></div>
                    <div className={styles2.div_group_text}>
                        <div className={styles2.div_text_amt}>{this.state.amtMega.toString().substring(0, this.state.amtMega.toString().length - 9)}
            ...
            <WingBlank style={{ marginLeft: 6, marginRight: 6 }}>
                ...
                <div className={styles2.primary_btn} style={{ marginBottom: 8, marginLeft: 8, marginRight: 8, height: 40, lineHeight: 40 }} onClick={() => { this.checkPaymega645() }}>
                    <Text>Đặt vé</Text>
                </div>
            </WingBlank>
        </div>)
