    ...
    if (this.state.isCheck && this.state.show == 1) {
      ...
      return (
        <div
          ...
          onClick={() => this.onOk()}
        >
          <Text style={{ fontFamily: "Helvetica" }}>TIẾP TỤC</Text>
        </div>
      )
    } else if (!this.state.isCheck && this.state.show == 1) {
      return (
        <div style={{ marginTop: 8 }}>
          <Flex>
            <Button
      ...
      <div>
        ...
        <WingBlank>
          ...
          <div>
            ...
            >
              <Text
                style={{ fontFamily: "Helvetica", color: "rgb(37, 56, 84)" }}
              >
                Họ tên
              </Text>
          ...
          {/* <InputItem
                            style={{ textAlign: "right", color: "#FF0000" }}
          ...
          >
            <div className="am-list-line">
              ...
              >
                <div
                  style={{ color: "rgb(37, 56, 84)", fontFamily: "Helvetica" }}
                >
                  Tiền vé
                </div>
              </div>
          ...
          {/* <div className="am-list-item am-input-item am-list-item-middle"  style={{minHeight: "30px", height: "30px"}}>
                            <div className="am-list-line">
                                <div style={{ width: 120 }} className="am-input-label am-input-label-5">
                                    <div style={{ color: "rgb(37, 56, 84)" }}>Phí chuyển phát</div>
                                </div>
                                <div className="am-input-control">
                                    <Text onChange={this.onChangeName} style={{ float: "right", color: "rgb(37, 56, 84)", fontSize: 17, fontFamily: "sans-serif" }}>
                                        {stringToNumberFormat(this.state.feeAmount)} đ
                                    </Text>
                                </div>
                            </div>
                        </div> */}
