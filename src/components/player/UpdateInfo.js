    ...
    render() {
        return (
            ...
            <div className={styles2.fixed_bottom}>
                <WingBlank>
                    <div className={styles2.primary_btn} style={{ marginTop: 10, fontFamily: "Helvetica", height: "38px", lineHeight: "38px" }} onClick={() => this.onOk()}><Text style={{ fontFamily: "Helvetica" }}>Cập nhật</Text></div>
                </WingBlank>
            </div>
        </div>
        );
