...
class Commission extends React.Component {
    ...
    render(){
        ...
        <div className={styles2.primary_btn} style={{ marginTop: 10, fontFamily: "Helvetica", height: "38px", lineHeight: "38px",marginLeft: 15, marginRight: 15 }} onClick={() => this.onCheck()}>
            <Text style={{ fontFamily: "Helvetica" }}>Yêu cầu rút hoa hồng</Text>
        </div>
