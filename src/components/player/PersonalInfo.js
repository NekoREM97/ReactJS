          ...
          >
            <Flex>
              <Flex.Item>
                ...
                />
                <Text
                  style={{ fontFamily: "Helvetica", color: "#253854" }}
                >
                  Hoa hồng
                </Text>
              </Flex.Item>
              <Flex.Item style={{ textAlign: "right" }}>
                <Text style={{ fontFamily: "Helvetica", color: "#e32e35",fontWeight:"bold" }}>
        ...
        <List>
          ...
          >
            <img
              ...
              style={{ width: 35, height: 30, paddingRight: 20 }}
            />
            <Text style={{ fontFamily: "Helvetica", color: "#253854" }}>
              Quản lý doanh thu
            </Text>
          </Item>
        </List>
          ...
          <Item onClick={() => {}} style={{ height: 150 }}>
            <Flex>
              <Flex.Item>
                ...
                <p style={{ color: "#5c5d5f", fontFamily: "Helvetica" }}>
