...
import styles2 from './History.css';
...
class PaymentHistoryItem extends React.Component {
  ...
  renderStatusWin = item => {
    ...
    if (item.ProductID === 5) {
      ...
      if (statusWin === "O") {
        value = <div className={styles.status_detail_item}>So kết quả</div>;
      } else if (statusWin === "A" || statusWin === "B" || statusWin === "C" || statusWin === "D" || statusWin === "E" || statusWin === "F" || statusWin === "G") {
        let amount =
          item.AmountA +
          item.AmountB +
          item.AmountC +
        ...
        if (this.state.status === "A" || this.state.status === "I") {
          return (
            <div style={{ position: "fixed", zIndex: "999" }}>
              <Button style={{ background: "rgba(0, 0, 0, 0)", color: "#d2403a", width: "80px", height: "25px", lineHeight: "25px", fontSize: "15px", textAlign: "center", margin: "0 auto", fontFamily: "Helvetica" }} onClick={() => this.ReportError(drawDate)}>
                <Text>Báo vé lỗi</Text>
              </Button>
              {/* <p style={{color: "#d2403a", border:2, borderColor:"#d2403a", fontFamily: "Helvetica"}}>Báo vé lỗi</p> */}
            </div>
          )
        } else {
          return (
      ...
      <div>
        ...
        >
          <div style={{ height: 270 }}>
            <div style={{ textAlign: "center", fontFamily: "Helvetica", fontWeight: "bold", color: "#1dbcbb", fontSize: 18 }}>Báo vé lỗi</div>
            <p style={{ color: "red", fontSize: 11, fontFamily: "Helvetica", marginBottom: 0 }}>Nếu thông tin trên vé không đúng, quý khách vui lòng nhập lý do tại đây</p>
            ...
            <div className={styles2.primary_btn} >
              <div onClick={() => { this.setState({ modal1: false, ReasonError: "" }) }} style={{ color: "#405675", width: "100%", fontSize: 15, fontFamily: "Helvetica" }}>ĐÓNG</div>
              <div style={{ color: "black" }}>|</div>
              <div onClick={() => this.onOk()} style={{ color: "#1dbcbb", width: "100%", fontSize: 15, fontFamily: "Helvetica" }}>GỬI</div>
            </div>
          </div>
        </Modal>
      </div>
      ...
      <div>
        ...
        >
          <div style={{ height: 190 }}>
            <div style={{ textAlign: "center", fontFamily: "Helvetica", fontWeight: "bold", color: "#1dbcbb", fontSize: 18 }}>Báo cáo vé lỗi</div>

            <div style={{ marginTop: 25, marginBottom: 25, color: "black", fontFamily: "Helvetica" }}>Vui lòng liên hệ hotline <a style={{ color: "#1dbcbb" }}>0346108989</a> để được hỗ trợ nếu thông tin trên vé không đúng</div>
            <div className={styles2.primary_btn} >
              <div onClick={() => { this.setState({ modal2: false }) }} style={{ color: "#405675", width: "100%", fontSize: 15, fontFamily: "Helvetica" }}>ĐÓNG</div>
            </div>
          </div>
        </Modal>
      </div>
