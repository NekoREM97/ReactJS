                  ...
                  <div>
                    ...
                    <div className={styles.result_max4d}>
                      <div className={styles.text_number_circle_st}>
                        {item.Result_ST.toString().substr(0, 1)}
                      </div>
                      <div className={styles.text_number_circle_st}>
                        {item.Result_ST.toString().substr(1, 1)}
                      </div>
                      <div className={styles.text_number_circle_st}>
                        {item.Result_ST.toString().substr(2, 1)}
                      </div>
                      <div className={styles.text_number_circle_st}>
                        {item.Result_ST.toString().substr(3, 1)}
                      </div>
                    </div>
                  </div>
                  <div>
                    ...
                    >
                      <div>
                        ...
                        <div className={styles.result_max4d}>
                          ...
                          >
                            {item.Result_ENC1.toString().substr(
                              0,
                              1
                            )}
                          </div>
                      ...
                      <div>
                        ...
                        <div className={styles.result_max4d}>
                          ...
                          >
                            {item.Result_ENC2.toString().substr(
                              0,
                              1
                            )}
                          </div>
