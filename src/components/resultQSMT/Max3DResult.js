...
class Max3DResult extends React.Component {
      ...
      return (
        <div>
          {this.state.max3d.map((item, index, data) => {
            ...
            const resultSt = item.Result_ST.split(",");
            const resultNd = item.Result_ND.split(",");
            const resultRd = item.Result_RD.split(",");
            const resultEnc = item.Result_ENC.split(",");
                ...
                <div className={styles.list_item}>
                  ...
                  <div className={styles.text_header}>
                    ...
                    <div className={styles.result_max3d}>
                        <div style={{paddingRight: 15, textAlign:"center", fontFamily: "Helvetica"}}>Giải nhất<p style={{marginTop: 0, marginBottom: 0, fontWeight:"bold"}}>1 Triệu</p></div>
                      <div
                      ...
                      <div style={{paddingLeft: 15, textAlign:"center", fontFamily: "Helvetica"}}>Giải nhất<p style={{marginTop: 0, marginBottom: 0, fontWeight:"bold"}}>1 Tỷ</p></div>
                    </div>
                  </div>
                  ...
                  <div className={styles.text_header}>
                    ...
                    <div style={{paddingRight: 20, textAlign:"center", fontFamily: "Helvetica"}}>Giải nhì<p style={{marginTop: 0, marginBottom: 0, fontWeight:"bold"}}>350k</p></div>
                      <div
                      ...
                      <div style={{paddingLeft: 15, textAlign:"center", fontFamily: "Helvetica"}}>Giải nhì<p style={{marginTop: 0, marginBottom: 0, fontWeight:"bold"}}>40 Triệu</p></div>
                    </div>
                    <div className={styles.result_max4d}>
                      <div
                        className={styles.text_number_circle_nd_max3d}
                  ...
                  <div className={styles.text_header}>
                    ...
                    <div className={styles.result_max4d}>
                    <div style={{paddingRight: 24, textAlign:"center", fontFamily: "Helvetica"}}>Giải ba<p style={{marginTop: 0, marginBottom: 0, fontWeight:"bold"}}>210k</p></div>
                      <div
                      ...
                      <div style={{paddingLeft: 15, textAlign:"center", fontFamily: "Helvetica"}}>Giải ba<p style={{marginTop: 0, marginBottom: 0, fontWeight:"bold"}}>10 Triệu</p></div>
                    </div>
                    <div className={styles.result_max4d}>
                      <div
                        className={styles.text_number_circle_rd_max3d}
                  ...
                  <div className={styles.text_header}>
                    ...
                    <div className={styles.result_max4d}>
                    <div style={{paddingRight: 15, textAlign:"center", fontFamily: "Helvetica"}}>Giải tư<p style={{marginTop: 0, marginBottom: 0, fontWeight:"bold"}}>100k</p></div>
                      <div
                      ...
                      <div style={{paddingLeft: 15, textAlign:"center", fontFamily: "Helvetica"}}>Giải tư<p style={{marginTop: 0, marginBottom: 0, fontWeight:"bold"}}>5 triệu</p></div>
                    </div>
                    <div className={styles.result_max4d}>
                      <div
                        className={styles.text_number_circle_enc_max3d}
                  ...
                  <div style={{borderBottom:"1px solid rgb(106, 109, 114)"}}>
                  <div className={styles.result_max3d}>
                        <div style={{paddingRight: 0, textAlign:"center", fontFamily: "Helvetica", paddingTop: 12, width: 235, fontSize: 12, paddingBottom: 12}}>(Max3D+) trúng 2 bộ số bất kỳ trong 20 bộ số của giải Nhất, Nhì, Ba và Tư</div>
                      <div style={{paddingLeft: 15, textAlign:"center", fontFamily: "Helvetica", paddingTop: 8}}>Giải năm<p style={{marginTop: 0, marginBottom: 0, fontWeight:"bold"}}>1 Triệu</p></div>
                    </div>
                    </div>
                        {/* Giải sáu */}
                        <div style={{borderBottom:"1px solid rgb(106, 109, 114)"}}>
                  <div className={styles.result_max3d}>
                        <div style={{paddingRight: 0, textAlign:"center", fontFamily: "Helvetica", paddingTop: 12, width: 235, fontSize: 12, paddingBottom: 12}}>(Max3D+) trúng 1 trong 2 bộ số của giải Nhất</div>
                      <div style={{paddingLeft: 15, textAlign:"center", fontFamily: "Helvetica", paddingTop: 8}}>Giải sáu<p style={{marginTop: 0, marginBottom: 0, fontWeight:"bold"}}>150k</p></div>
                    </div>
                    </div>
                        {/* Giải bảy */}
                        <div>
                  <div className={styles.result_max3d}>
                        <div style={{paddingRight: 0, textAlign:"center", fontFamily: "Helvetica", paddingTop: 12, width: 235, fontSize: 12, paddingBottom: 20}}>(Max3D+) trúng 1 bộ số bất kỳ trong 18 bộ số của giải Nhì, Ba, và Tư trừ 2 bộ giải nhất</div>
                      <div style={{paddingLeft: 15, textAlign:"center", fontFamily: "Helvetica", paddingTop: 8}}>Giải bảy<p style={{marginTop: 0, marginBottom: 0, fontWeight:"bold"}}>40k</p></div>
                    </div>
                    </div>
                  <div
                    style={{
  ...
  render() {
    return (
      <div style={{ background: "#EEEEEE", paddingTop: 2 }} className={styles.font}>
        {this.renderView()}
      </div>
    );
  }
