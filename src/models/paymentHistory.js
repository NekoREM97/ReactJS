...
export default {
  ...
  effects: {
    ...
    *getDataPending({ payload: productID }, { call, put }) {
      ...
      data.MobileNumber = localStorage.getItem("mobileNumber");
      data.MerchantID = localStorage.getItem("merchant_id");
      const pending = yield call(payment.GetOrderPendingError, data);
    ...
    *getGetSuccess({ payload: value }, { call, put }) {
      ...
      data.MobileNumber = localStorage.getItem("mobileNumber");
      data.MerchantID = localStorage.getItem("merchant_id");
      const success = yield call(payment.GetOrderSuccess, data);
    ...
    *getGetError({ payload: pageIndex }, { call, put }) {
      ...
      data.MobileNumber = localStorage.getItem("mobileNumber");
      data.MerchantID = localStorage.getItem("merchant_id");
      const dataError = yield call(payment.GetOrderPendingError, data);
      yield put({
        type: "save",
        dataError: dataError,
        pending: "",
